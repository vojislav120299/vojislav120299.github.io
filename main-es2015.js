...
const AppRoutes = [
    {
        ...
        children: [
            ...
            {
                path: 'orderlist',
                loadChildren: () => __webpack_require__.e(/*! import() | orderList-orderList-module */ "orderList-orderList-module").then(__webpack_require__.bind(null, /*! ./orderList/orderList.module */ "./src/app/orderList/orderList.module.ts")).then(m => m.OrderListModule)
            }
        ]
    }
];
...
/* harmony import */ var _header_header_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./header/header.component */ "./src/app/layouts/full/header/header.component.ts");
/* harmony import */ var _sidebar_sidebar_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sidebar/sidebar.component */ "./src/app/layouts/full/sidebar/sidebar.component.ts");
...
FullComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: FullComponent, selectors: [["app-full-layout"]], decls: 20, vars: 5, consts: [[1, "main-container"], [1, "topbar", "telative", 2, "background-color", "black"], [1, "navbar-header"], ["href", "index.html", 1, "navbar-brand"], ["src", "assets/images/firmLogo.png", "fxShow", "false", "fxShow.gt-xs", "", "alt", "homepage", 1, "light-logo", 2, "height", "-webkit-fill-available"], ["fxShow", "false", "fxShow.gt-xs", ""], ["mat-icon-button", "", "value", "sidebarclosed", 2, "color", "white", 3, "click"], ["fxFlex", ""], [1, "example-sidenav-container"], ["id", "snav", "fixedTopGap", "0", 1, "dark-sidebar", "pl-xs", 3, "mode", "opened", "disableClose"], ["snav", ""], [1, "page-wrapper"], [1, "page-content"]], template: function FullComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function FullComponent_Template_button_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](14); return _r0.toggle(); });
...
AppHeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppHeaderComponent, selectors: [["app-header"]], decls: 2, vars: 0, consts: [[1, "mymegamenu", 2, "background-color", "black"], ["profile", "matMenu"]], template: function AppHeaderComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-menu", 0, 1);
    } }, directives: [_angular_material__WEBPACK_IMPORTED_MODULE_1__["_MatMenu"]], encapsulation: 2 });
...
function AppSidebarComponent_mat_list_item_2_a_1_span_6_Template(rf, ctx) { if (rf & 1) {
...
function AppSidebarComponent_mat_list_item_2_a_1_Template(rf, ctx) { if (rf & 1) {
...
function AppSidebarComponent_mat_list_item_2_Template(rf, ctx) { if (rf & 1) {
...
AppSidebarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppSidebarComponent, selectors: [["app-sidebar"]], decls: 3, vars: 1, consts: [[1, "user-profile"], ["appAccordion", ""], ["appAccordionLink", "", "routerLinkActive", "selected", 3, "group", 4, "ngFor", "ngForOf"], ["appAccordionLink", "", "routerLinkActive", "selected", 3, "group"], ["class", "", "appAccordionToggle", "", 3, "routerLink", 4, "ngIf"], ["appAccordionToggle", "", 1, "", 3, "routerLink"], ["fxFlex", ""], [3, "class", 4, "ngFor", "ngForOf"]], template: function AppSidebarComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! D:\Users\Voja\Desktop\ordersApp\src\main.ts */"./src/main.ts");
